...
public class GobelinMaker {
    ...
    public static void setLookAndFeel() throws FontFormatException, IOException {
        ...
        Font font = Font.createFont(Font.TRUETYPE_FONT, GobelinMaker.class.getResourceAsStream("/org/gobelinmaker/gobelinmaker/theme/cour.ttf")).deriveFont(Font.BOLD, 14);
